...
function listeyeEkle()
{
    ...
    if(girilen != "")
    {
        ...
        btnTamamla.setAttribute("src","assets/tamam.png");
...
function sil()
{
    ...
    secilen.remove();
    document.getElementById("sonuc").innerHTML="your selection has been deleted!";
...
function tamamla()
{
    ...
    sil();
    document.getElementById("sonuc").innerHTML="Your selection has been moved!";
}
